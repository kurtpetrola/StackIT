...
public class GamePauseManager7 : MonoBehaviour
{
    public GameObject pausePanel; // Reference to the UI panel that should be displayed
    public ScoreManagerMap7 scoreManager; // Reference to the ScoreManagerMap1 script
    public int scoreToPauseAt = 35; // The score at which the game should pause and show the panel
