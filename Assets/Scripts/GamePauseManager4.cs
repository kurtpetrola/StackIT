...
public class GamePauseManager4 : MonoBehaviour
{
    public GameObject pausePanel; // Reference to the UI panel that should be displayed
    public ScoreManagerMap4 scoreManager; // Reference to the ScoreManagerMap1 script
    public int scoreToPauseAt = 20; // The score at which the game should pause and show the panel
