...
public class BoxScript7 : MonoBehaviour
{
    ...
    private ScoreManagerMap7 scoreManager;
    ...
    void Awake()
    {
        ...
        scoreManager = FindObjectOfType<ScoreManagerMap7>();
    ...
    void Start()
    {
        ...
        GameplayController.instance.currentBox7 = this;
    }
