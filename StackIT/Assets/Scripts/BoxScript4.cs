...
public class BoxScript4 : MonoBehaviour
{
    ...
    private ScoreManagerMap4 scoreManager;
    ...
    {   
        ...
        scoreManager = FindObjectOfType<ScoreManagerMap4>();
    ...
    void Start()
    {
        ...
        GameplayController.instance.currentBox4 = this;
    }
