...
public class BoxScript8 : MonoBehaviour
{
    ...
    private ScoreManagerMap8 scoreManager;
    ...
    void Awake()
    {
        ...
        scoreManager = FindObjectOfType<ScoreManagerMap8>();
    ...
    void Start()
    {
        ...
        GameplayController.instance.currentBox8 = this;
    }
