...
public class ScoreManagerMap5 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        isLockRemoved = PlayerPrefs.GetInt(LockStateKey5, 0) == 1;
        isButtonEnabled = PlayerPrefs.GetInt(ButtonStateKey5, 0) == 1;
        ...
        lockedItemImage6.SetActive(isLockedImage1Active);
