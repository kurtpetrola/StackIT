...
public class BoxScript5 : MonoBehaviour
{
    ...
    private ScoreManagerMap5 scoreManager;
    ...
    void Awake()
    {
        ...
        scoreManager = FindObjectOfType<ScoreManagerMap5>();
    ...
    void Start()
    {
        ...
        GameplayController.instance.currentBox5 = this;
    }
