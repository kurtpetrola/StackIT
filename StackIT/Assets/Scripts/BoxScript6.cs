...
public class BoxScript6 : MonoBehaviour
{
    ...
    private ScoreManagerMap6 scoreManager;

    private float currentBoxMoveSpeed = 4f;
    ...
    void Awake()
    {
        ...
        scoreManager = FindObjectOfType<ScoreManagerMap6>();
    ...
    void Start()
    {
        ...
        GameplayController.instance.currentBox6 = this;
    }
