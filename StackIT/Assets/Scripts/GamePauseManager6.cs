...
public class GamePauseManager6 : MonoBehaviour
{
    public GameObject pausePanel; // Reference to the UI panel that should be displayed
    public ScoreManagerMap6 scoreManager; // Reference to the ScoreManagerMap1 script
    public int scoreToPauseAt = 30; // The score at which the game should pause and show the panel
